...
export const en: Dictionary = {
  ...
  'control.paint.help':
    'Click panels to light them: the wheel gives them their colour. The next click opens a new group, so one wall can carry several colours. Click a panel again to switch it off.',
